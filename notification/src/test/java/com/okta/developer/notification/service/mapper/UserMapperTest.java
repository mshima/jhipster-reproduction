...
class UserMapperTest {
    ...
    void init() {
        ...
        Instant creationTimestamp = Instant.ofEpochMilli(1617901618889L);
        ...
        userDto = new AdminUserRest(user);
    }

    @Test
    void testUserToUserDTO() {
        AdminUserRest convertedUserDto = userMapper.userToAdminUserDTO(user);
    ...
    void usersToUserDTOsShouldMapOnlyNonNullUsers() {
        ...
        List<UserRest> userDTOS = userMapper.usersToUserDTOs(users);
    ...
    void userDTOsToUsersShouldMapOnlyNonNullUsers() {
        List<AdminUserRest> usersDto = new ArrayList<>();
