...
describe('EntityWithServiceImplPaginationAndDTO Management Delete Component', () => {
  let comp: EntityWithServiceImplPaginationAndDTODeleteDialog;
  let fixture: ComponentFixture<EntityWithServiceImplPaginationAndDTODeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithServiceImplPaginationAndDTODeleteDialog);
