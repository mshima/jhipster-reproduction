...
import entityWithServiceImplPaginationAndDTOResolve from './entity-with-service-impl-pagination-and-dto-routing-resolve.service';
...
describe('EntityWithServiceImplPaginationAndDTO routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEntityWithServiceImplPaginationAndDTO returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          entityWithServiceImplPaginationAndDTOResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(entityWithServiceImplPaginationAndDTOResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
