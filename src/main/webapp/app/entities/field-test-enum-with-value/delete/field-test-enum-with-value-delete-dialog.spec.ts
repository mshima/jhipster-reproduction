...
import { FieldTestEnumWithValueDeleteDialog } from './field-test-enum-with-value-delete-dialog';

describe('FieldTestEnumWithValue Management Delete Component', () => {
  let comp: FieldTestEnumWithValueDeleteDialog;
  let fixture: ComponentFixture<FieldTestEnumWithValueDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestEnumWithValueDeleteDialog);
