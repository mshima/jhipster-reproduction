...
import entityWithServiceClassPaginationAndDTOResolve from './entity-with-service-class-pagination-and-dto-routing-resolve.service';
...
describe('EntityWithServiceClassPaginationAndDTO routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEntityWithServiceClassPaginationAndDTO returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          entityWithServiceClassPaginationAndDTOResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(entityWithServiceClassPaginationAndDTOResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
