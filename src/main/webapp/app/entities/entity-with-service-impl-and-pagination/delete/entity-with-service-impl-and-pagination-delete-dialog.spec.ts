...
describe('EntityWithServiceImplAndPagination Management Delete Component', () => {
  let comp: EntityWithServiceImplAndPaginationDeleteDialog;
  let fixture: ComponentFixture<EntityWithServiceImplAndPaginationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithServiceImplAndPaginationDeleteDialog);
