...
import entityWithServiceImplAndPaginationResolve from './entity-with-service-impl-and-pagination-routing-resolve.service';
...
describe('EntityWithServiceImplAndPagination routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEntityWithServiceImplAndPagination returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          entityWithServiceImplAndPaginationResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(entityWithServiceImplAndPaginationResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
