...
describe('FieldTestEntity Management Delete Component', () => {
  let comp: FieldTestEntityDeleteDialog;
  let fixture: ComponentFixture<FieldTestEntityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestEntityDeleteDialog);
