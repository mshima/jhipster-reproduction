...
type FieldTestEntityFormGroupContent = {
  ...
  localTimeTom: FormControl<FieldTestEntityFormRawValue['localTimeTom']>;
  localTimeRequiredTom: FormControl<FieldTestEntityFormRawValue['localTimeRequiredTom']>;
...
export class FieldTestEntityFormService {
  createFieldTestEntityFormGroup(fieldTestEntity?: FieldTestEntityFormGroupInput): FieldTestEntityFormGroup {
    const fieldTestEntityRawValue = this.convertFieldTestEntityToFieldTestEntityRawValue({
      ...this.getFormDefaults(),
      ...(fieldTestEntity ?? { id: null }),
    });
    ...
    return new FormGroup<FieldTestEntityFormGroupContent>({
      ...
      localTimeTom: new FormControl(fieldTestEntityRawValue.localTimeTom),
      localTimeRequiredTom: new FormControl(fieldTestEntityRawValue.localTimeRequiredTom, {
        validators: [Validators.required],
      }),
  ...
  getFieldTestEntity(form: FieldTestEntityFormGroup): IFieldTestEntity | NewFieldTestEntity {
    return this.convertFieldTestEntityRawValueToFieldTestEntity(form.getRawValue());
  }
