...
describe('FieldTestEntity Management Update Component', () => {
  let comp: FieldTestEntityUpdate;
  let fixture: ComponentFixture<FieldTestEntityUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestEntityUpdate);
  ...
  describe('ngOnInit', () => {
    it('should update editForm', () => {
      const fieldTestEntity: IFieldTestEntity = { id: 23260 };
  ...
  describe('save', () => {
    it('should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<IFieldTestEntity>();
      const fieldTestEntity = { id: 7565 };
      vi.spyOn(fieldTestEntityFormService, 'getFieldTestEntity').mockReturnValue(fieldTestEntity);
      vi.spyOn(fieldTestEntityService, 'update').mockReturnValue(saveSubject);
      ...
      saveSubject.next(fieldTestEntity);
    ...
    it('should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<IFieldTestEntity>();
      const fieldTestEntity = { id: 7565 };
      vi.spyOn(fieldTestEntityFormService, 'getFieldTestEntity').mockReturnValue({ id: null });
      vi.spyOn(fieldTestEntityService, 'create').mockReturnValue(saveSubject);
      vi.spyOn(comp, 'previousState');
