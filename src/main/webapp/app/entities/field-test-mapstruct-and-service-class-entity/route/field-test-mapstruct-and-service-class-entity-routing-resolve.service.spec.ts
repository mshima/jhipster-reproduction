...
import fieldTestMapstructAndServiceClassEntityResolve from './field-test-mapstruct-and-service-class-entity-routing-resolve.service';
...
describe('FieldTestMapstructAndServiceClassEntity routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IFieldTestMapstructAndServiceClassEntity returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          fieldTestMapstructAndServiceClassEntityResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(fieldTestMapstructAndServiceClassEntityResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
