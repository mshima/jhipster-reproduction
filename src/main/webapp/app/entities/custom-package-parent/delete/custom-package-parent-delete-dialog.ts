...
@Component({
  templateUrl: './custom-package-parent-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class CustomPackageParentDeleteDialog {
  customPackageParent?: ICustomPackageParent;
  ...
  confirmDelete(id: number): void {
    this.customPackageParentService.delete(id).subscribe(() => {
