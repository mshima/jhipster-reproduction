...
import { CustomPackageParentDeleteDialog } from './custom-package-parent-delete-dialog';

describe('CustomPackageParent Management Delete Component', () => {
  let comp: CustomPackageParentDeleteDialog;
  let fixture: ComponentFixture<CustomPackageParentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CustomPackageParentDeleteDialog);
