...
import fieldTestServiceClassAndJpaFilteringEntityResolve from './field-test-service-class-and-jpa-filtering-entity-routing-resolve.service';
...
describe('FieldTestServiceClassAndJpaFilteringEntity routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IFieldTestServiceClassAndJpaFilteringEntity returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          fieldTestServiceClassAndJpaFilteringEntityResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(fieldTestServiceClassAndJpaFilteringEntityResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
