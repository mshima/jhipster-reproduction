...
describe('FieldTestServiceClassAndJpaFilteringEntity Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a FieldTestServiceClassAndJpaFilteringEntity', () => {
      ...
      service.create(fieldTestServiceClassAndJpaFilteringEntity).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a FieldTestServiceClassAndJpaFilteringEntity', () => {
      ...
      service.update(fieldTestServiceClassAndJpaFilteringEntity).subscribe(resp => (expectedResult = resp));
    ...
    describe('addFieldTestServiceClassAndJpaFilteringEntityToCollectionIfMissing', () => {
      it('should add a FieldTestServiceClassAndJpaFilteringEntity to an empty array', () => {
        ...
        expect(expectedResult).toEqual([fieldTestServiceClassAndJpaFilteringEntity]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([fieldTestServiceClassAndJpaFilteringEntity, fieldTestServiceClassAndJpaFilteringEntity2]);
      });
