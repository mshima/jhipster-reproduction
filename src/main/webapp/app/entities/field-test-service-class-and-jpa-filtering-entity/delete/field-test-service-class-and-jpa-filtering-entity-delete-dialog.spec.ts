...
describe('FieldTestServiceClassAndJpaFilteringEntity Management Delete Component', () => {
  let comp: FieldTestServiceClassAndJpaFilteringEntityDeleteDialog;
  let fixture: ComponentFixture<FieldTestServiceClassAndJpaFilteringEntityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestServiceClassAndJpaFilteringEntityDeleteDialog);
