...
describe('EntityWithServiceImplAndDTO Management Delete Component', () => {
  let comp: EntityWithServiceImplAndDTODeleteDialog;
  let fixture: ComponentFixture<EntityWithServiceImplAndDTODeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithServiceImplAndDTODeleteDialog);
