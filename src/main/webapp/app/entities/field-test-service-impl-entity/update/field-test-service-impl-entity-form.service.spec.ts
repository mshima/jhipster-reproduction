  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            localTimeMika: expect.any(Object),
            localTimeRequiredMika: expect.any(Object),
    ...
    describe('getFieldTestServiceImplEntity', () => {
      it('should return NewFieldTestServiceImplEntity for default FieldTestServiceImplEntity initial value', () => {
        ...
        const fieldTestServiceImplEntity = service.getFieldTestServiceImplEntity(formGroup);
