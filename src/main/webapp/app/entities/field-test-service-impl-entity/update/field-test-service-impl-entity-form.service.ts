...
type FieldTestServiceImplEntityFormGroupContent = {
  ...
  localTimeMika: FormControl<FieldTestServiceImplEntityFormRawValue['localTimeMika']>;
  localTimeRequiredMika: FormControl<FieldTestServiceImplEntityFormRawValue['localTimeRequiredMika']>;
...
export class FieldTestServiceImplEntityFormService {
  createFieldTestServiceImplEntityFormGroup(
    fieldTestServiceImplEntity?: FieldTestServiceImplEntityFormGroupInput,
    ...
    const fieldTestServiceImplEntityRawValue = this.convertFieldTestServiceImplEntityToFieldTestServiceImplEntityRawValue({
      ...
      ...(fieldTestServiceImplEntity ?? { id: null }),
    });
    ...
    return new FormGroup<FieldTestServiceImplEntityFormGroupContent>({
      ...
      localTimeMika: new FormControl(fieldTestServiceImplEntityRawValue.localTimeMika),
      localTimeRequiredMika: new FormControl(fieldTestServiceImplEntityRawValue.localTimeRequiredMika, {
        validators: [Validators.required],
      }),
  ...
  getFieldTestServiceImplEntity(form: FieldTestServiceImplEntityFormGroup): IFieldTestServiceImplEntity | NewFieldTestServiceImplEntity {
    return this.convertFieldTestServiceImplEntityRawValueToFieldTestServiceImplEntity(form.getRawValue());
  }
  ...
  private convertFieldTestServiceImplEntityToFieldTestServiceImplEntityRawValue(
    fieldTestServiceImplEntity:
      IFieldTestServiceImplEntity | (Partial<NewFieldTestServiceImplEntity> & FieldTestServiceImplEntityFormDefaults),
