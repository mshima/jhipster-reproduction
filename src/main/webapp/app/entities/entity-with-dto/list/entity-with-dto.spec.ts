...
import { sampleWithRequiredData } from '../entity-with-dto.test-samples';
...
describe('EntityWithDTO Management Component', () => {
  ...
  let comp: EntityWithDTO;
  let fixture: ComponentFixture<EntityWithDTO>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithDTO);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 13981 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
    await vi.runAllTimersAsync();

    // THEN
    expect(comp.isLoading()).toEqual(false);
    expect(comp.entityWithDTOS()[0]).toEqual(expect.objectContaining({ id: 13981 }));
  });

  describe('trackId', () => {
    it('should forward to entityWithDTOService', () => {
      const entity = { id: 13981 };
      vi.spyOn(service, 'getEntityWithDTOIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.entityWithDTOSParams()).toMatchObject({ sort: ['id,desc'] });
  });
