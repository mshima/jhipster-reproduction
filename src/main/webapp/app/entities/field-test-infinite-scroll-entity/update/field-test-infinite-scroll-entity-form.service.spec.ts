  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            localTimeHugo: expect.any(Object),
            localTimeRequiredHugo: expect.any(Object),
    ...
    describe('getFieldTestInfiniteScrollEntity', () => {
      it('should return NewFieldTestInfiniteScrollEntity for default FieldTestInfiniteScrollEntity initial value', () => {
        ...
        const fieldTestInfiniteScrollEntity = service.getFieldTestInfiniteScrollEntity(formGroup);
