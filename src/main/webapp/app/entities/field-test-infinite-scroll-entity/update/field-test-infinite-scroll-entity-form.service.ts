...
type FieldTestInfiniteScrollEntityFormGroupInput =
  IFieldTestInfiniteScrollEntity | PartialWithRequiredKeyOf<NewFieldTestInfiniteScrollEntity>;
...
type FieldTestInfiniteScrollEntityFormGroupContent = {
  ...
  localTimeHugo: FormControl<FieldTestInfiniteScrollEntityFormRawValue['localTimeHugo']>;
  localTimeRequiredHugo: FormControl<FieldTestInfiniteScrollEntityFormRawValue['localTimeRequiredHugo']>;
...
export class FieldTestInfiniteScrollEntityFormService {
  createFieldTestInfiniteScrollEntityFormGroup(
    ...
    const fieldTestInfiniteScrollEntityRawValue = this.convertFieldTestInfiniteScrollEntityToFieldTestInfiniteScrollEntityRawValue({
      ...
      ...(fieldTestInfiniteScrollEntity ?? { id: null }),
    });
    ...
    return new FormGroup<FieldTestInfiniteScrollEntityFormGroupContent>({
      ...
      localTimeHugo: new FormControl(fieldTestInfiniteScrollEntityRawValue.localTimeHugo),
      localTimeRequiredHugo: new FormControl(fieldTestInfiniteScrollEntityRawValue.localTimeRequiredHugo, {
        validators: [Validators.required],
      }),
  ...
  getFieldTestInfiniteScrollEntity(
    ...
    return this.convertFieldTestInfiniteScrollEntityRawValueToFieldTestInfiniteScrollEntity(form.getRawValue());
  }
  ...
  private convertFieldTestInfiniteScrollEntityToFieldTestInfiniteScrollEntityRawValue(
    fieldTestInfiniteScrollEntity:
      IFieldTestInfiniteScrollEntity | (Partial<NewFieldTestInfiniteScrollEntity> & FieldTestInfiniteScrollEntityFormDefaults),
