...
import fieldTestInfiniteScrollEntityResolve from './field-test-infinite-scroll-entity-routing-resolve.service';
...
describe('FieldTestInfiniteScrollEntity routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IFieldTestInfiniteScrollEntity returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          fieldTestInfiniteScrollEntityResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(fieldTestInfiniteScrollEntityResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
