...
describe('FieldTestInfiniteScrollEntity Management Delete Component', () => {
  let comp: FieldTestInfiniteScrollEntityDeleteDialog;
  let fixture: ComponentFixture<FieldTestInfiniteScrollEntityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestInfiniteScrollEntityDeleteDialog);
