  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            localTimeAlice: expect.any(Object),
            localTimeRequiredAlice: expect.any(Object),
    ...
    describe('getFieldTestPaginationEntity', () => {
      it('should return NewFieldTestPaginationEntity for default FieldTestPaginationEntity initial value', () => {
        ...
        const fieldTestPaginationEntity = service.getFieldTestPaginationEntity(formGroup);
