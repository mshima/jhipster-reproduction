...
type FieldTestPaginationEntityFormGroupContent = {
  ...
  localTimeAlice: FormControl<FieldTestPaginationEntityFormRawValue['localTimeAlice']>;
  localTimeRequiredAlice: FormControl<FieldTestPaginationEntityFormRawValue['localTimeRequiredAlice']>;
...
export class FieldTestPaginationEntityFormService {
  createFieldTestPaginationEntityFormGroup(
    fieldTestPaginationEntity?: FieldTestPaginationEntityFormGroupInput,
    ...
    const fieldTestPaginationEntityRawValue = this.convertFieldTestPaginationEntityToFieldTestPaginationEntityRawValue({
      ...
      ...(fieldTestPaginationEntity ?? { id: null }),
    });
    ...
    return new FormGroup<FieldTestPaginationEntityFormGroupContent>({
      ...
      localTimeAlice: new FormControl(fieldTestPaginationEntityRawValue.localTimeAlice),
      localTimeRequiredAlice: new FormControl(fieldTestPaginationEntityRawValue.localTimeRequiredAlice, {
        validators: [Validators.required],
      }),
  ...
  getFieldTestPaginationEntity(form: FieldTestPaginationEntityFormGroup): IFieldTestPaginationEntity | NewFieldTestPaginationEntity {
    return this.convertFieldTestPaginationEntityRawValueToFieldTestPaginationEntity(form.getRawValue());
  }
