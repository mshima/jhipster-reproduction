...
import fieldTestPaginationEntityResolve from './field-test-pagination-entity-routing-resolve.service';
...
describe('FieldTestPaginationEntity routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IFieldTestPaginationEntity returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          fieldTestPaginationEntityResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(fieldTestPaginationEntityResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
