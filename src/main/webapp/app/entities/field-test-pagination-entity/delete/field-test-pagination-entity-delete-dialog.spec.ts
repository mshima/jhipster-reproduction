...
describe('FieldTestPaginationEntity Management Delete Component', () => {
  let comp: FieldTestPaginationEntityDeleteDialog;
  let fixture: ComponentFixture<FieldTestPaginationEntityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FieldTestPaginationEntityDeleteDialog);
