...
import { CustomPackageChildDeleteDialog } from './custom-package-child-delete-dialog';

describe('CustomPackageChild Management Delete Component', () => {
  let comp: CustomPackageChildDeleteDialog;
  let fixture: ComponentFixture<CustomPackageChildDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CustomPackageChildDeleteDialog);
