...
import entityWithServiceClassAndPaginationResolve from './entity-with-service-class-and-pagination-routing-resolve.service';
...
describe('EntityWithServiceClassAndPagination routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEntityWithServiceClassAndPagination returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          entityWithServiceClassAndPaginationResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(entityWithServiceClassAndPaginationResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
