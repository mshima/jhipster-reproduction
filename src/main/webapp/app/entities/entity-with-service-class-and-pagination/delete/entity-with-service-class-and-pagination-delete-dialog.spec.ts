...
describe('EntityWithServiceClassAndPagination Management Delete Component', () => {
  let comp: EntityWithServiceClassAndPaginationDeleteDialog;
  let fixture: ComponentFixture<EntityWithServiceClassAndPaginationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithServiceClassAndPaginationDeleteDialog);
