...
describe('MapsIdUserProfileWithDTO Management Delete Component', () => {
  let comp: MapsIdUserProfileWithDTODeleteDialog;
  let fixture: ComponentFixture<MapsIdUserProfileWithDTODeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MapsIdUserProfileWithDTODeleteDialog);
