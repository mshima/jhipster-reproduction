...
describe('BankAccountMySuffix Management Delete Component', () => {
  let comp: BankAccountMySuffixDeleteDialog;
  let fixture: ComponentFixture<BankAccountMySuffixDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankAccountMySuffixDeleteDialog);
