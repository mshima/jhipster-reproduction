...
import { sampleWithRequiredData } from '../bank-account-my-suffix.test-samples';
...
describe('BankAccountMySuffix Management Component', () => {
  ...
  let comp: BankAccountMySuffix;
  let fixture: ComponentFixture<BankAccountMySuffix>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankAccountMySuffix);
  ...
  describe('trackId', () => {
    it('should forward to bankAccountService', () => {
      ...
      vi.spyOn(service, 'getBankAccountMySuffixIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBankAccountMySuffixIdentifier).toHaveBeenCalledWith(entity);
