...
describe('EntityWithPaginationAndDTO Management Delete Component', () => {
  let comp: EntityWithPaginationAndDTODeleteDialog;
  let fixture: ComponentFixture<EntityWithPaginationAndDTODeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityWithPaginationAndDTODeleteDialog);
