...
import entityWithPaginationAndDTOResolve from './entity-with-pagination-and-dto-routing-resolve.service';
...
describe('EntityWithPaginationAndDTO routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEntityWithPaginationAndDTO returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          entityWithPaginationAndDTOResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(entityWithPaginationAndDTOResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
