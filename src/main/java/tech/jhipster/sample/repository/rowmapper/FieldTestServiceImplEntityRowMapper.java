...
public class FieldTestServiceImplEntityRowMapper implements BiFunction<Row, String, FieldTestServiceImplEntity> {
    ...
    public FieldTestServiceImplEntity apply(Row row, String prefix) {
        ...
        entity.setLocalTimeMika(converter.fromRow(row, prefix + "_local_time_mika", LocalTime.class));
        entity.setLocalTimeRequiredMika(converter.fromRow(row, prefix + "_local_time_required_mika", LocalTime.class));
