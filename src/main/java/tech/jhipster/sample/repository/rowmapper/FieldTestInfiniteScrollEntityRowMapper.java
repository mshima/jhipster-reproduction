...
public class FieldTestInfiniteScrollEntityRowMapper implements BiFunction<Row, String, FieldTestInfiniteScrollEntity> {
    ...
    public FieldTestInfiniteScrollEntity apply(Row row, String prefix) {
        ...
        entity.setLocalTimeHugo(converter.fromRow(row, prefix + "_local_time_hugo", LocalTime.class));
        entity.setLocalTimeRequiredHugo(converter.fromRow(row, prefix + "_local_time_required_hugo", LocalTime.class));
