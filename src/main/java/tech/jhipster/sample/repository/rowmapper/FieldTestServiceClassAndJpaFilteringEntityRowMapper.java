    ...
    implements BiFunction<Row, String, FieldTestServiceClassAndJpaFilteringEntity>
{
    ...
    public FieldTestServiceClassAndJpaFilteringEntity apply(Row row, String prefix) {
        ...
        entity.setLocalTimeBob(converter.fromRow(row, prefix + "_local_time_bob", LocalTime.class));
        entity.setLocalTimeRequiredBob(converter.fromRow(row, prefix + "_local_time_required_bob", LocalTime.class));
