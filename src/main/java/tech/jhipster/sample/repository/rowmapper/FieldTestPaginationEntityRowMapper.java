...
public class FieldTestPaginationEntityRowMapper implements BiFunction<Row, String, FieldTestPaginationEntity> {
    ...
    public FieldTestPaginationEntity apply(Row row, String prefix) {
        ...
        entity.setLocalTimeAlice(converter.fromRow(row, prefix + "_local_time_alice", LocalTime.class));
        entity.setLocalTimeRequiredAlice(converter.fromRow(row, prefix + "_local_time_required_alice", LocalTime.class));
