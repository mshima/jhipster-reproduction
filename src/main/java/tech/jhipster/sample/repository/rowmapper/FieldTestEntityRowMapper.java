...
public class FieldTestEntityRowMapper implements BiFunction<Row, String, FieldTestEntity> {
    ...
    public FieldTestEntity apply(Row row, String prefix) {
        ...
        entity.setLocalTimeTom(converter.fromRow(row, prefix + "_local_time_tom", LocalTime.class));
        entity.setLocalTimeRequiredTom(converter.fromRow(row, prefix + "_local_time_required_tom", LocalTime.class));
