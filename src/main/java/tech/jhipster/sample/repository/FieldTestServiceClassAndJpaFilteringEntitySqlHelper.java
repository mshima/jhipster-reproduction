...
public class FieldTestServiceClassAndJpaFilteringEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_bob", table, columnPrefix + "_local_time_bob"));
        columns.add(Column.aliased("local_time_required_bob", table, columnPrefix + "_local_time_required_bob"));
