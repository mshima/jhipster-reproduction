...
public class FieldTestInfiniteScrollEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_hugo", table, columnPrefix + "_local_time_hugo"));
        columns.add(Column.aliased("local_time_required_hugo", table, columnPrefix + "_local_time_required_hugo"));
