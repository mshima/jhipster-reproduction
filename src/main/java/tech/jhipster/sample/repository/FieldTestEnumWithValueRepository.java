...
/**
 * Spring Data R2DBC repository for the FieldTestEnumWithValue entity.
 */
@SuppressWarnings("unused")
@Repository
public interface FieldTestEnumWithValueRepository
    extends ReactiveCrudRepository<FieldTestEnumWithValue, Long>, FieldTestEnumWithValueRepositoryInternal
{
    @Override
