...
public class FieldTestMapstructAndServiceClassEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_eva", table, columnPrefix + "_local_time_eva"));
        columns.add(Column.aliased("local_time_required_eva", table, columnPrefix + "_local_time_required_eva"));
