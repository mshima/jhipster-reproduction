...
public class FieldTestPaginationEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_alice", table, columnPrefix + "_local_time_alice"));
        columns.add(Column.aliased("local_time_required_alice", table, columnPrefix + "_local_time_required_alice"));
