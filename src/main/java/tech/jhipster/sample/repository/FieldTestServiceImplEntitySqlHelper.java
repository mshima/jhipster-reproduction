...
public class FieldTestServiceImplEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_mika", table, columnPrefix + "_local_time_mika"));
        columns.add(Column.aliased("local_time_required_mika", table, columnPrefix + "_local_time_required_mika"));
