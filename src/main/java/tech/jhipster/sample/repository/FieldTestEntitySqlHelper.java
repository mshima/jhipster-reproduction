...
public class FieldTestEntitySqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("local_time_tom", table, columnPrefix + "_local_time_tom"));
        columns.add(Column.aliased("local_time_required_tom", table, columnPrefix + "_local_time_required_tom"));
