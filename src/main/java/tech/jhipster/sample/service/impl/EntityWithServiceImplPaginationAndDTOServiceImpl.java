...
/**
 * Service Implementation for managing {@link tech.jhipster.sample.domain.EntityWithServiceImplPaginationAndDTO}.
 */
@Service
@Transactional
public class EntityWithServiceImplPaginationAndDTOServiceImpl implements EntityWithServiceImplPaginationAndDTOService {

    private static final Logger LOG = LoggerFactory.getLogger(EntityWithServiceImplPaginationAndDTOServiceImpl.class);
    ...
    @Override
    public Mono<EntityWithServiceImplPaginationAndDTODTO> update(
        EntityWithServiceImplPaginationAndDTODTO entityWithServiceImplPaginationAndDTODTO
    ) {
        LOG.debug("Request to update EntityWithServiceImplPaginationAndDTO : {}", entityWithServiceImplPaginationAndDTODTO);
        return entityWithServiceImplPaginationAndDTORepository
            .save(entityWithServiceImplPaginationAndDTOMapper.toEntity(entityWithServiceImplPaginationAndDTODTO))
            .map(entityWithServiceImplPaginationAndDTOMapper::toDto);
    }
