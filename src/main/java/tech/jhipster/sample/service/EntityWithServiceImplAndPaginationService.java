...
/**
 * Service Interface for managing {@link tech.jhipster.sample.domain.EntityWithServiceImplAndPagination}.
 */
public interface EntityWithServiceImplAndPaginationService {
    ...
    /**
     * Updates a entityWithServiceImplAndPagination.
     *
     * @param entityWithServiceImplAndPagination the entity to update.
     * @return the persisted entity.
     */
    Mono<EntityWithServiceImplAndPagination> update(EntityWithServiceImplAndPagination entityWithServiceImplAndPagination);
