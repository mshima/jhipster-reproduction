...
/**
 * Service Implementation for managing {@link tech.jhipster.sample.domain.FieldTestMapstructAndServiceClassEntity}.
 */
@Service
@Transactional
public class FieldTestMapstructAndServiceClassEntityService {

    private static final Logger LOG = LoggerFactory.getLogger(FieldTestMapstructAndServiceClassEntityService.class);
