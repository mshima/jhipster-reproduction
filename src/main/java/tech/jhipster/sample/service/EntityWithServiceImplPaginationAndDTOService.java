...
public interface EntityWithServiceImplPaginationAndDTOService {
    ...
    /**
     * Updates a entityWithServiceImplPaginationAndDTO.
     *
     * @param entityWithServiceImplPaginationAndDTODTO the entity to update.
     * @return the persisted entity.
     */
    Mono<EntityWithServiceImplPaginationAndDTODTO> update(
