...
/**
 * Service Implementation for managing {@link tech.jhipster.sample.domain.EntityWithServiceClassPaginationAndDTO}.
 */
@Service
@Transactional
public class EntityWithServiceClassPaginationAndDTOService {

    private static final Logger LOG = LoggerFactory.getLogger(EntityWithServiceClassPaginationAndDTOService.class);
    ...
    /**
     * Update a entityWithServiceClassPaginationAndDTO.
     *
     * @param entityWithServiceClassPaginationAndDTODTO the entity to save.
     * @return the persisted entity.
     */
    public Mono<EntityWithServiceClassPaginationAndDTODTO> update(
        EntityWithServiceClassPaginationAndDTODTO entityWithServiceClassPaginationAndDTODTO
    ) {
        LOG.debug("Request to update EntityWithServiceClassPaginationAndDTO : {}", entityWithServiceClassPaginationAndDTODTO);
        return entityWithServiceClassPaginationAndDTORepository
            .save(entityWithServiceClassPaginationAndDTOMapper.toEntity(entityWithServiceClassPaginationAndDTODTO))
            .map(entityWithServiceClassPaginationAndDTOMapper::toDto);
    }
