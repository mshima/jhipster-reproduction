...
/**
 * Service Interface for managing {@link tech.jhipster.sample.domain.FieldTestServiceImplEntity}.
 */
public interface FieldTestServiceImplEntityService {
    ...
    /**
     * Updates a fieldTestServiceImplEntity.
     *
     * @param fieldTestServiceImplEntity the entity to update.
     * @return the persisted entity.
     */
    Mono<FieldTestServiceImplEntity> update(FieldTestServiceImplEntity fieldTestServiceImplEntity);
