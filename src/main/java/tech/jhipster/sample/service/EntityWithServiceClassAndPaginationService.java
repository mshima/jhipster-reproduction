...
/**
 * Service Implementation for managing {@link tech.jhipster.sample.domain.EntityWithServiceClassAndPagination}.
 */
@Service
@Transactional
public class EntityWithServiceClassAndPaginationService {

    private static final Logger LOG = LoggerFactory.getLogger(EntityWithServiceClassAndPaginationService.class);
    ...
    /**
     * Update a entityWithServiceClassAndPagination.
     *
     * @param entityWithServiceClassAndPagination the entity to save.
     * @return the persisted entity.
     */
    public Mono<EntityWithServiceClassAndPagination> update(EntityWithServiceClassAndPagination entityWithServiceClassAndPagination) {
        LOG.debug("Request to update EntityWithServiceClassAndPagination : {}", entityWithServiceClassAndPagination);
        return entityWithServiceClassAndPaginationRepository.save(entityWithServiceClassAndPagination);
    }
    ...
    public Mono<EntityWithServiceClassAndPagination> partialUpdate(
        ...
        return entityWithServiceClassAndPaginationRepository
            ...
            .map(existingEntityWithServiceClassAndPagination -> {
                updateIfPresent(existingEntityWithServiceClassAndPagination::setEnzo, entityWithServiceClassAndPagination.getEnzo());
