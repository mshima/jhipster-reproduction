...
public interface EntityWithServiceImplAndDTOService {
    ...
    /**
     * Updates a entityWithServiceImplAndDTO.
     *
     * @param entityWithServiceImplAndDTODTO the entity to update.
     * @return the persisted entity.
     */
    Mono<EntityWithServiceImplAndDTODTO> update(EntityWithServiceImplAndDTODTO entityWithServiceImplAndDTODTO);
