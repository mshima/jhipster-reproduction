...
public class FieldTestMapstructAndServiceClassEntity implements Serializable {
    ...
    @Column("local_time_eva")
    private LocalTime localTimeEva;

    @NotNull
    @Column("local_time_required_eva")
    private LocalTime localTimeRequiredEva;
    ...
    public LocalTime getLocalTimeEva() {
        return this.localTimeEva;
    }

    public FieldTestMapstructAndServiceClassEntity localTimeEva(LocalTime localTimeEva) {
        this.setLocalTimeEva(localTimeEva);
        return this;
    }

    public void setLocalTimeEva(LocalTime localTimeEva) {
        this.localTimeEva = localTimeEva;
    }

    public LocalTime getLocalTimeRequiredEva() {
        return this.localTimeRequiredEva;
    }

    public FieldTestMapstructAndServiceClassEntity localTimeRequiredEva(LocalTime localTimeRequiredEva) {
        this.setLocalTimeRequiredEva(localTimeRequiredEva);
        return this;
    }

    public void setLocalTimeRequiredEva(LocalTime localTimeRequiredEva) {
        this.localTimeRequiredEva = localTimeRequiredEva;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestMapstructAndServiceClassEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestMapstructAndServiceClassEntity{" +
            ...
            ", localTimeEva='" + getLocalTimeEva() + "'" +
            ", localTimeRequiredEva='" + getLocalTimeRequiredEva() + "'" +
