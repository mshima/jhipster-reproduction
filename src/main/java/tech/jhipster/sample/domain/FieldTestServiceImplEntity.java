...
public class FieldTestServiceImplEntity implements Serializable {
    ...
    @Column("local_time_mika")
    private LocalTime localTimeMika;

    @NotNull
    @Column("local_time_required_mika")
    private LocalTime localTimeRequiredMika;
    ...
    public LocalTime getLocalTimeMika() {
        return this.localTimeMika;
    }

    public FieldTestServiceImplEntity localTimeMika(LocalTime localTimeMika) {
        this.setLocalTimeMika(localTimeMika);
        return this;
    }

    public void setLocalTimeMika(LocalTime localTimeMika) {
        this.localTimeMika = localTimeMika;
    }

    public LocalTime getLocalTimeRequiredMika() {
        return this.localTimeRequiredMika;
    }

    public FieldTestServiceImplEntity localTimeRequiredMika(LocalTime localTimeRequiredMika) {
        this.setLocalTimeRequiredMika(localTimeRequiredMika);
        return this;
    }

    public void setLocalTimeRequiredMika(LocalTime localTimeRequiredMika) {
        this.localTimeRequiredMika = localTimeRequiredMika;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestServiceImplEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestServiceImplEntity{" +
            ...
            ", localTimeMika='" + getLocalTimeMika() + "'" +
            ", localTimeRequiredMika='" + getLocalTimeRequiredMika() + "'" +
