...
public class FieldTestEntity implements Serializable {
    ...
    @Column("local_time_tom")
    private LocalTime localTimeTom;

    @NotNull
    @Column("local_time_required_tom")
    private LocalTime localTimeRequiredTom;
    ...
    public LocalTime getLocalTimeTom() {
        return this.localTimeTom;
    }

    public FieldTestEntity localTimeTom(LocalTime localTimeTom) {
        this.setLocalTimeTom(localTimeTom);
        return this;
    }

    public void setLocalTimeTom(LocalTime localTimeTom) {
        this.localTimeTom = localTimeTom;
    }

    public LocalTime getLocalTimeRequiredTom() {
        return this.localTimeRequiredTom;
    }

    public FieldTestEntity localTimeRequiredTom(LocalTime localTimeRequiredTom) {
        this.setLocalTimeRequiredTom(localTimeRequiredTom);
        return this;
    }

    public void setLocalTimeRequiredTom(LocalTime localTimeRequiredTom) {
        this.localTimeRequiredTom = localTimeRequiredTom;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestEntity{" +
            ...
            ", localTimeTom='" + getLocalTimeTom() + "'" +
            ", localTimeRequiredTom='" + getLocalTimeRequiredTom() + "'" +
