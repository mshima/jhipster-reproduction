...
/**
 * Criteria class for the {@link tech.jhipster.sample.domain.BankAccount} entity. This class is used
 * in {@link tech.jhipster.sample.web.rest.BankAccountResource} to receive all the possible filtering options from
...
public class BankAccountCriteria implements Serializable, Criteria {
    ...
    private DurationFilter meanQueueDuration;
    ...
    public BankAccountCriteria(BankAccountCriteria other) {
        ...
        this.guid = other.optionalGuid().map(UUIDFilter::copy).orElse(null);
        ...
        this.meanQueueDuration = other.optionalMeanQueueDuration().map(DurationFilter::copy).orElse(null);
    ...
    public Optional<UUIDFilter> optionalGuid() {
        return Optional.ofNullable(guid);
    }

    public UUIDFilter guid() {
        if (guid == null) {
            setGuid(new UUIDFilter());
        }
        return guid;
    }
    ...
    public DurationFilter getMeanQueueDuration() {
        return meanQueueDuration;
    }

    public Optional<DurationFilter> optionalMeanQueueDuration() {
        return Optional.ofNullable(meanQueueDuration);
    }

    public DurationFilter meanQueueDuration() {
        if (meanQueueDuration == null) {
            setMeanQueueDuration(new DurationFilter());
        }
        return meanQueueDuration;
    }

    public void setMeanQueueDuration(DurationFilter meanQueueDuration) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(meanQueueDuration, that.meanQueueDuration) &&
    ...
    public String toString() {
        return "BankAccountCriteria{" +
            ...
            optionalGuid().map(f -> "guid=" + f + ", ").orElse("") +
            ...
            optionalMeanQueueDuration().map(f -> "meanQueueDuration=" + f + ", ").orElse("") +
