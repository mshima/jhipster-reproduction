...
public class FieldTestInfiniteScrollEntity implements Serializable {
    ...
    @Column("local_time_hugo")
    private LocalTime localTimeHugo;

    @NotNull
    @Column("local_time_required_hugo")
    private LocalTime localTimeRequiredHugo;
    ...
    public LocalTime getLocalTimeHugo() {
        return this.localTimeHugo;
    }

    public FieldTestInfiniteScrollEntity localTimeHugo(LocalTime localTimeHugo) {
        this.setLocalTimeHugo(localTimeHugo);
        return this;
    }

    public void setLocalTimeHugo(LocalTime localTimeHugo) {
        this.localTimeHugo = localTimeHugo;
    }

    public LocalTime getLocalTimeRequiredHugo() {
        return this.localTimeRequiredHugo;
    }

    public FieldTestInfiniteScrollEntity localTimeRequiredHugo(LocalTime localTimeRequiredHugo) {
        this.setLocalTimeRequiredHugo(localTimeRequiredHugo);
        return this;
    }

    public void setLocalTimeRequiredHugo(LocalTime localTimeRequiredHugo) {
        this.localTimeRequiredHugo = localTimeRequiredHugo;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestInfiniteScrollEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestInfiniteScrollEntity{" +
            ...
            ", localTimeHugo='" + getLocalTimeHugo() + "'" +
            ", localTimeRequiredHugo='" + getLocalTimeRequiredHugo() + "'" +
