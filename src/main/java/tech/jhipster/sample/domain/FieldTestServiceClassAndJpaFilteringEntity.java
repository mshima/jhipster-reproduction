...
public class FieldTestServiceClassAndJpaFilteringEntity implements Serializable {
    ...
    @Column("local_time_bob")
    private LocalTime localTimeBob;

    @NotNull
    @Column("local_time_required_bob")
    private LocalTime localTimeRequiredBob;
    ...
    public LocalTime getLocalTimeBob() {
        return this.localTimeBob;
    }

    public FieldTestServiceClassAndJpaFilteringEntity localTimeBob(LocalTime localTimeBob) {
        this.setLocalTimeBob(localTimeBob);
        return this;
    }

    public void setLocalTimeBob(LocalTime localTimeBob) {
        this.localTimeBob = localTimeBob;
    }

    public LocalTime getLocalTimeRequiredBob() {
        return this.localTimeRequiredBob;
    }

    public FieldTestServiceClassAndJpaFilteringEntity localTimeRequiredBob(LocalTime localTimeRequiredBob) {
        this.setLocalTimeRequiredBob(localTimeRequiredBob);
        return this;
    }

    public void setLocalTimeRequiredBob(LocalTime localTimeRequiredBob) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestServiceClassAndJpaFilteringEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestServiceClassAndJpaFilteringEntity{" +
            ...
            ", localTimeBob='" + getLocalTimeBob() + "'" +
            ", localTimeRequiredBob='" + getLocalTimeRequiredBob() + "'" +
