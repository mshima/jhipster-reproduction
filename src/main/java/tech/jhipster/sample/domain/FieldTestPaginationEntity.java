...
public class FieldTestPaginationEntity implements Serializable {
    ...
    @Column("local_time_alice")
    private LocalTime localTimeAlice;

    @NotNull
    @Column("local_time_required_alice")
    private LocalTime localTimeRequiredAlice;
    ...
    public LocalTime getLocalTimeAlice() {
        return this.localTimeAlice;
    }

    public FieldTestPaginationEntity localTimeAlice(LocalTime localTimeAlice) {
        this.setLocalTimeAlice(localTimeAlice);
        return this;
    }

    public void setLocalTimeAlice(LocalTime localTimeAlice) {
        this.localTimeAlice = localTimeAlice;
    }

    public LocalTime getLocalTimeRequiredAlice() {
        return this.localTimeRequiredAlice;
    }

    public FieldTestPaginationEntity localTimeRequiredAlice(LocalTime localTimeRequiredAlice) {
        this.setLocalTimeRequiredAlice(localTimeRequiredAlice);
        return this;
    }

    public void setLocalTimeRequiredAlice(LocalTime localTimeRequiredAlice) {
        this.localTimeRequiredAlice = localTimeRequiredAlice;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((FieldTestPaginationEntity) o).getId());
    }
    ...
    public String toString() {
        return "FieldTestPaginationEntity{" +
            ...
            ", localTimeAlice='" + getLocalTimeAlice() + "'" +
            ", localTimeRequiredAlice='" + getLocalTimeRequiredAlice() + "'" +
