...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '5276538c-3d42-499c-8eb9-892bf504a1bf' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'sampleWebfluxPsqlApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('cf35dd77-b4b0-4e74-8714-3c663254cc89');
      cy.get(`[data-cy="name"]`).should('have.value', 'cf35dd77-b4b0-4e74-8714-3c663254cc89');
