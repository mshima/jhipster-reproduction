...
describe('Operation e2e test', () => {
  ...
  let username: string;
  let password: string;
  const operationSample = { date: '2015-08-04T20:58:33.314Z', amount: 2886.33 };
  ...
  describe('Operation page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Operation').should('not.contain', 'sampleWebfluxPsqlApp.testRootOperation.home.title');
    });
  ...
  describe('new Operation page', () => {
    ...
    it('should create an instance of Operation', () => {
      cy.get(`[data-cy="date"]`).type('2015-08-05T04:21');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2015-08-05T04:21');

      cy.get(`[data-cy="description"]`).type('unless gadzooks');
      cy.get(`[data-cy="description"]`).should('have.value', 'unless gadzooks');

      cy.get(`[data-cy="amount"]`).type('5756.42');
      cy.get(`[data-cy="amount"]`).should('have.value', '5756.42');
