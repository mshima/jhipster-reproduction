...
describe('Operation e2e test', () => {
  ...
  let username: string;
  let password: string;
  const operationSample = { date: '2015-08-04T23:30:16.931Z', amount: 10312.2 };
  ...
  describe('Operation page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Operation').should('not.contain', 'sampleWebfluxH2MemApp.testRootOperation.home.title');
    });
  ...
  describe('new Operation page', () => {
    ...
    it('should create an instance of Operation', () => {
      cy.get(`[data-cy="date"]`).type('2015-08-04T22:57');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2015-08-04T22:57');

      cy.get(`[data-cy="description"]`).type('how');
      cy.get(`[data-cy="description"]`).should('have.value', 'how');

      cy.get(`[data-cy="amount"]`).type('19931.68');
      cy.get(`[data-cy="amount"]`).should('have.value', '19931.68');
