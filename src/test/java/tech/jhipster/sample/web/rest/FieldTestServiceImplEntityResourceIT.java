...
import static tech.jhipster.sample.domain.FieldTestServiceImplEntityAsserts.*;
...
class FieldTestServiceImplEntityResourceIT {
    ...
    private static final LocalDate UPDATED_LOCAL_DATE_MIKA = LocalDate.parse("2020-08-04");

    private static final LocalDate DEFAULT_LOCAL_DATE_REQUIRED_MIKA = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_LOCAL_DATE_REQUIRED_MIKA = LocalDate.parse("2020-08-04");

    private static final Instant DEFAULT_INSTANT_MIKA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_INSTANT_MIKA = Instant.ofEpochMilli(1596513172471L);

    private static final Instant DEFAULT_INSTANTE_REQUIRED_MIKA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_INSTANTE_REQUIRED_MIKA = Instant.ofEpochMilli(1596513172471L);
    ...
    private static final ZonedDateTime UPDATED_ZONED_DATE_TIME_MIKA = ZonedDateTime.ofInstant(
    ...
    private static final ZonedDateTime UPDATED_ZONED_DATE_TIME_REQUIRED_MIKA = ZonedDateTime.ofInstant(
        Instant.ofEpochMilli(1596513172471L),
        ZoneOffset.UTC
    );

    private static final LocalTime DEFAULT_LOCAL_TIME_MIKA = LocalTime.NOON;
    private static final LocalTime UPDATED_LOCAL_TIME_MIKA = LocalTime.MAX.withNano(0);

    private static final LocalTime DEFAULT_LOCAL_TIME_REQUIRED_MIKA = LocalTime.NOON;
    private static final LocalTime UPDATED_LOCAL_TIME_REQUIRED_MIKA = LocalTime.MAX.withNano(0);
    ...
    private FieldTestServiceImplEntity insertedFieldTestServiceImplEntity;
     ...
     */
    public static FieldTestServiceImplEntity createEntity() {
        return new FieldTestServiceImplEntity()
            ...
            .localTimeMika(DEFAULT_LOCAL_TIME_MIKA)
            .localTimeRequiredMika(DEFAULT_LOCAL_TIME_REQUIRED_MIKA)
     ...
     * if they test an entity which requires the current entity.
     */
    public static FieldTestServiceImplEntity createUpdatedEntity() {
        return new FieldTestServiceImplEntity()
            ...
            .localTimeMika(UPDATED_LOCAL_TIME_MIKA)
            .localTimeRequiredMika(UPDATED_LOCAL_TIME_REQUIRED_MIKA)
    ...
    @BeforeEach
    void initTest() {
        fieldTestServiceImplEntity = createEntity();
    }

    @AfterEach
    void cleanup() {
        if (insertedFieldTestServiceImplEntity != null) {
            fieldTestServiceImplEntityRepository.delete(insertedFieldTestServiceImplEntity).block();
            insertedFieldTestServiceImplEntity = null;
        }
        deleteEntities(em);
    }
    ...
    void createFieldTestServiceImplEntity() throws Exception {
        ...
        var returnedFieldTestServiceImplEntity = webTestClient
            .post()
            .uri(ENTITY_API_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(fieldTestServiceImplEntity))
            .exchange()
            .expectStatus()
            .isCreated()
            .expectBody(FieldTestServiceImplEntity.class)
            .returnResult()
            .getResponseBody();

        // Validate the FieldTestServiceImplEntity in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(
            returnedFieldTestServiceImplEntity,
            getPersistedFieldTestServiceImplEntity(returnedFieldTestServiceImplEntity)
        );

        insertedFieldTestServiceImplEntity = returnedFieldTestServiceImplEntity;
    }
    ...
    @Test
    void checkLocalTimeRequiredMikaIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        fieldTestServiceImplEntity.setLocalTimeRequiredMika(null);
    ...
    void getAllFieldTestServiceImplEntitiesAsStream() {
        ...
        // assertFieldTestServiceImplEntityAllPropertiesEquals(fieldTestServiceImplEntity, testFieldTestServiceImplEntity);
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(fieldTestServiceImplEntity, testFieldTestServiceImplEntity);
    }

    @Test
    void getAllFieldTestServiceImplEntities() {
        // Initialize the database
        insertedFieldTestServiceImplEntity = fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity).block();
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_DOUBLE_REQUIRED_MIKA))
            .jsonPath("$.[*].doubleMinMika")
            .value(hasItem(DEFAULT_DOUBLE_MIN_MIKA))
            .jsonPath("$.[*].doubleMaxMika")
            .value(hasItem(DEFAULT_DOUBLE_MAX_MIKA))
            ...
            .jsonPath("$.[*].localTimeMika")
            .value(hasItem(DEFAULT_LOCAL_TIME_MIKA.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.[*].localTimeRequiredMika")
            .value(hasItem(DEFAULT_LOCAL_TIME_REQUIRED_MIKA.format(LOCAL_DATE_TIME_FORMAT)))
            ...
            .value(hasItem(DEFAULT_BOOLEAN_MIKA))
            .jsonPath("$.[*].booleanRequiredMika")
            .value(hasItem(DEFAULT_BOOLEAN_REQUIRED_MIKA))
            .jsonPath("$.[*].enumMika")
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_REQUIRED_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MINBYTES_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MAXBYTES_MIKA)))
            .jsonPath("$.[*].byteAnyMikaContentType")
            .value(hasItem(DEFAULT_BYTE_ANY_MIKA_CONTENT_TYPE))
            .jsonPath("$.[*].byteAnyMika")
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_REQUIRED_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MINBYTES_MIKA)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MAXBYTES_MIKA)))
            .jsonPath("$.[*].byteTextMika")
            .value(hasItem(DEFAULT_BYTE_TEXT_MIKA))
            .jsonPath("$.[*].byteTextRequiredMika")
            .value(hasItem(DEFAULT_BYTE_TEXT_REQUIRED_MIKA));
    }
    ...
    void getFieldTestServiceImplEntity() {
        ...
        webTestClient
            ...
            .jsonPath("$.doubleRequiredMika")
            .value(is(DEFAULT_DOUBLE_REQUIRED_MIKA))
            .jsonPath("$.doubleMinMika")
            .value(is(DEFAULT_DOUBLE_MIN_MIKA))
            .jsonPath("$.doubleMaxMika")
            .value(is(DEFAULT_DOUBLE_MAX_MIKA))
            .jsonPath("$.bigDecimalRequiredMika")
            ...
            .jsonPath("$.localTimeMika")
            .value(is(DEFAULT_LOCAL_TIME_MIKA.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.localTimeRequiredMika")
            .value(is(DEFAULT_LOCAL_TIME_REQUIRED_MIKA.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.durationMika")
            .value(is(DEFAULT_DURATION_MIKA.toString()))
            .jsonPath("$.durationRequiredMika")
            .value(is(DEFAULT_DURATION_REQUIRED_MIKA.toString()))
            .jsonPath("$.booleanMika")
            .value(is(DEFAULT_BOOLEAN_MIKA))
            .jsonPath("$.booleanRequiredMika")
            .value(is(DEFAULT_BOOLEAN_REQUIRED_MIKA))
            .jsonPath("$.enumMika")
            ...
            .jsonPath("$.byteImageMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MIKA)))
            .jsonPath("$.byteImageRequiredMikaContentType")
            .value(is(DEFAULT_BYTE_IMAGE_REQUIRED_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteImageRequiredMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_REQUIRED_MIKA)))
            .jsonPath("$.byteImageMinbytesMikaContentType")
            .value(is(DEFAULT_BYTE_IMAGE_MINBYTES_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteImageMinbytesMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MINBYTES_MIKA)))
            .jsonPath("$.byteImageMaxbytesMikaContentType")
            .value(is(DEFAULT_BYTE_IMAGE_MAXBYTES_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteImageMaxbytesMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MAXBYTES_MIKA)))
            .jsonPath("$.byteAnyMikaContentType")
            .value(is(DEFAULT_BYTE_ANY_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteAnyMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MIKA)))
            .jsonPath("$.byteAnyRequiredMikaContentType")
            .value(is(DEFAULT_BYTE_ANY_REQUIRED_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteAnyRequiredMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_REQUIRED_MIKA)))
            .jsonPath("$.byteAnyMinbytesMikaContentType")
            .value(is(DEFAULT_BYTE_ANY_MINBYTES_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteAnyMinbytesMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MINBYTES_MIKA)))
            .jsonPath("$.byteAnyMaxbytesMikaContentType")
            .value(is(DEFAULT_BYTE_ANY_MAXBYTES_MIKA_CONTENT_TYPE))
            .jsonPath("$.byteAnyMaxbytesMika")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MAXBYTES_MIKA)))
            .jsonPath("$.byteTextMika")
            .value(is(DEFAULT_BYTE_TEXT_MIKA))
            .jsonPath("$.byteTextRequiredMika")
            .value(is(DEFAULT_BYTE_TEXT_REQUIRED_MIKA));
    }
    ...
    @Test
    void putExistingFieldTestServiceImplEntity() throws Exception {
        // Initialize the database
        insertedFieldTestServiceImplEntity = fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity).block();
        ...
        webTestClient
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(updatedFieldTestServiceImplEntity))
            .exchange()
            .expectStatus()
            .isOk();
        ...
        assertPersistedFieldTestServiceImplEntityToMatchAllProperties(updatedFieldTestServiceImplEntity);
    }

    @Test
    void putNonExistingFieldTestServiceImplEntity() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        fieldTestServiceImplEntity.setId(longCount.incrementAndGet());
    ...
    void partialUpdateFieldTestServiceImplEntityWithPatch() throws Exception {
        ...
        webTestClient
            ...
            .bodyValue(om.writeValueAsBytes(partialUpdatedFieldTestServiceImplEntity))
            .exchange()
            .expectStatus()
            .isOk();
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(
            createUpdateProxyForBean(partialUpdatedFieldTestServiceImplEntity, fieldTestServiceImplEntity),
            getPersistedFieldTestServiceImplEntity(fieldTestServiceImplEntity)
        );
    }
    ...
    void fullUpdateFieldTestServiceImplEntityWithPatch() throws Exception {
        ...
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(
            partialUpdatedFieldTestServiceImplEntity,
            getPersistedFieldTestServiceImplEntity(partialUpdatedFieldTestServiceImplEntity)
        );
    }
    ...
    protected long getRepositoryCount() {
        return fieldTestServiceImplEntityRepository.count().block();
    }
    ...
    protected FieldTestServiceImplEntity getPersistedFieldTestServiceImplEntity(FieldTestServiceImplEntity fieldTestServiceImplEntity) {
        return fieldTestServiceImplEntityRepository.findById(fieldTestServiceImplEntity.getId()).block();
    }

    protected void assertPersistedFieldTestServiceImplEntityToMatchAllProperties(
        FieldTestServiceImplEntity expectedFieldTestServiceImplEntity
    ) {
        // Test fails because reactive api returns an empty object instead of null
        // assertFieldTestServiceImplEntityAllPropertiesEquals(expectedFieldTestServiceImplEntity, getPersistedFieldTestServiceImplEntity(expectedFieldTestServiceImplEntity));
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(
            expectedFieldTestServiceImplEntity,
            getPersistedFieldTestServiceImplEntity(expectedFieldTestServiceImplEntity)
        );
    }

    protected void assertPersistedFieldTestServiceImplEntityToMatchUpdatableProperties(
        FieldTestServiceImplEntity expectedFieldTestServiceImplEntity
    ) {
        // Test fails because reactive api returns an empty object instead of null
        // assertFieldTestServiceImplEntityAllUpdatablePropertiesEquals(expectedFieldTestServiceImplEntity, getPersistedFieldTestServiceImplEntity(expectedFieldTestServiceImplEntity));
        assertFieldTestServiceImplEntityUpdatableFieldsEquals(
            expectedFieldTestServiceImplEntity,
            getPersistedFieldTestServiceImplEntity(expectedFieldTestServiceImplEntity)
        );
