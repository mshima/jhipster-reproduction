...
import static tech.jhipster.sample.domain.FieldTestInfiniteScrollEntityAsserts.*;
...
class FieldTestInfiniteScrollEntityResourceIT {
    ...
    private static final LocalDate UPDATED_LOCAL_DATE_HUGO = LocalDate.parse("2020-08-04");

    private static final LocalDate DEFAULT_LOCAL_DATE_REQUIRED_HUGO = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_LOCAL_DATE_REQUIRED_HUGO = LocalDate.parse("2020-08-04");

    private static final Instant DEFAULT_INSTANT_HUGO = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_INSTANT_HUGO = Instant.ofEpochMilli(1596513172471L);

    private static final Instant DEFAULT_INSTANTE_REQUIRED_HUGO = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_INSTANTE_REQUIRED_HUGO = Instant.ofEpochMilli(1596513172471L);
    ...
    private static final ZonedDateTime UPDATED_ZONED_DATE_TIME_HUGO = ZonedDateTime.ofInstant(
    ...
    private static final ZonedDateTime UPDATED_ZONED_DATE_TIME_REQUIRED_HUGO = ZonedDateTime.ofInstant(
        Instant.ofEpochMilli(1596513172471L),
        ZoneOffset.UTC
    );

    private static final LocalTime DEFAULT_LOCAL_TIME_HUGO = LocalTime.NOON;
    private static final LocalTime UPDATED_LOCAL_TIME_HUGO = LocalTime.MAX.withNano(0);

    private static final LocalTime DEFAULT_LOCAL_TIME_REQUIRED_HUGO = LocalTime.NOON;
    private static final LocalTime UPDATED_LOCAL_TIME_REQUIRED_HUGO = LocalTime.MAX.withNano(0);
    ...
    private FieldTestInfiniteScrollEntity insertedFieldTestInfiniteScrollEntity;
     ...
     */
    public static FieldTestInfiniteScrollEntity createEntity() {
        return new FieldTestInfiniteScrollEntity()
            ...
            .localTimeHugo(DEFAULT_LOCAL_TIME_HUGO)
            .localTimeRequiredHugo(DEFAULT_LOCAL_TIME_REQUIRED_HUGO)
     ...
     * if they test an entity which requires the current entity.
     */
    public static FieldTestInfiniteScrollEntity createUpdatedEntity() {
        return new FieldTestInfiniteScrollEntity()
            ...
            .localTimeHugo(UPDATED_LOCAL_TIME_HUGO)
            .localTimeRequiredHugo(UPDATED_LOCAL_TIME_REQUIRED_HUGO)
    ...
    @BeforeEach
    void initTest() {
        fieldTestInfiniteScrollEntity = createEntity();
    }

    @AfterEach
    void cleanup() {
        if (insertedFieldTestInfiniteScrollEntity != null) {
            fieldTestInfiniteScrollEntityRepository.delete(insertedFieldTestInfiniteScrollEntity).block();
            insertedFieldTestInfiniteScrollEntity = null;
        }
        deleteEntities(em);
    }
    ...
    void createFieldTestInfiniteScrollEntity() throws Exception {
        ...
        var returnedFieldTestInfiniteScrollEntity = webTestClient
            .post()
            .uri(ENTITY_API_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(fieldTestInfiniteScrollEntity))
            .exchange()
            .expectStatus()
            .isCreated()
            .expectBody(FieldTestInfiniteScrollEntity.class)
            .returnResult()
            .getResponseBody();

        // Validate the FieldTestInfiniteScrollEntity in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertFieldTestInfiniteScrollEntityUpdatableFieldsEquals(
            returnedFieldTestInfiniteScrollEntity,
            getPersistedFieldTestInfiniteScrollEntity(returnedFieldTestInfiniteScrollEntity)
        );

        insertedFieldTestInfiniteScrollEntity = returnedFieldTestInfiniteScrollEntity;
    }
    ...
    @Test
    void checkLocalTimeRequiredHugoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        fieldTestInfiniteScrollEntity.setLocalTimeRequiredHugo(null);
    ...
    void getAllFieldTestInfiniteScrollEntities() {
        ...
        insertedFieldTestInfiniteScrollEntity = fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity).block();
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_DOUBLE_REQUIRED_HUGO))
            .jsonPath("$.[*].doubleMinHugo")
            .value(hasItem(DEFAULT_DOUBLE_MIN_HUGO))
            .jsonPath("$.[*].doubleMaxHugo")
            .value(hasItem(DEFAULT_DOUBLE_MAX_HUGO))
            ...
            .jsonPath("$.[*].localTimeHugo")
            .value(hasItem(DEFAULT_LOCAL_TIME_HUGO.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.[*].localTimeRequiredHugo")
            .value(hasItem(DEFAULT_LOCAL_TIME_REQUIRED_HUGO.format(LOCAL_DATE_TIME_FORMAT)))
            ...
            .value(hasItem(DEFAULT_BOOLEAN_HUGO))
            .jsonPath("$.[*].booleanRequiredHugo")
            .value(hasItem(DEFAULT_BOOLEAN_REQUIRED_HUGO))
            .jsonPath("$.[*].enumHugo")
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_REQUIRED_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MINBYTES_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MAXBYTES_HUGO)))
            .jsonPath("$.[*].byteAnyHugoContentType")
            .value(hasItem(DEFAULT_BYTE_ANY_HUGO_CONTENT_TYPE))
            .jsonPath("$.[*].byteAnyHugo")
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_REQUIRED_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MINBYTES_HUGO)))
            ...
            .value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MAXBYTES_HUGO)))
            .jsonPath("$.[*].byteTextHugo")
            .value(hasItem(DEFAULT_BYTE_TEXT_HUGO))
            .jsonPath("$.[*].byteTextRequiredHugo")
            .value(hasItem(DEFAULT_BYTE_TEXT_REQUIRED_HUGO));
    }
    ...
    void getFieldTestInfiniteScrollEntity() {
        ...
        webTestClient
            ...
            .jsonPath("$.doubleRequiredHugo")
            .value(is(DEFAULT_DOUBLE_REQUIRED_HUGO))
            .jsonPath("$.doubleMinHugo")
            .value(is(DEFAULT_DOUBLE_MIN_HUGO))
            .jsonPath("$.doubleMaxHugo")
            .value(is(DEFAULT_DOUBLE_MAX_HUGO))
            .jsonPath("$.bigDecimalRequiredHugo")
            ...
            .jsonPath("$.localTimeHugo")
            .value(is(DEFAULT_LOCAL_TIME_HUGO.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.localTimeRequiredHugo")
            .value(is(DEFAULT_LOCAL_TIME_REQUIRED_HUGO.format(LOCAL_DATE_TIME_FORMAT)))
            .jsonPath("$.durationHugo")
            .value(is(DEFAULT_DURATION_HUGO.toString()))
            .jsonPath("$.durationRequiredHugo")
            .value(is(DEFAULT_DURATION_REQUIRED_HUGO.toString()))
            .jsonPath("$.booleanHugo")
            .value(is(DEFAULT_BOOLEAN_HUGO))
            .jsonPath("$.booleanRequiredHugo")
            .value(is(DEFAULT_BOOLEAN_REQUIRED_HUGO))
            .jsonPath("$.enumHugo")
            ...
            .jsonPath("$.byteImageHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_HUGO)))
            .jsonPath("$.byteImageRequiredHugoContentType")
            .value(is(DEFAULT_BYTE_IMAGE_REQUIRED_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteImageRequiredHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_REQUIRED_HUGO)))
            .jsonPath("$.byteImageMinbytesHugoContentType")
            .value(is(DEFAULT_BYTE_IMAGE_MINBYTES_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteImageMinbytesHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MINBYTES_HUGO)))
            .jsonPath("$.byteImageMaxbytesHugoContentType")
            .value(is(DEFAULT_BYTE_IMAGE_MAXBYTES_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteImageMaxbytesHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_IMAGE_MAXBYTES_HUGO)))
            .jsonPath("$.byteAnyHugoContentType")
            .value(is(DEFAULT_BYTE_ANY_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteAnyHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_HUGO)))
            .jsonPath("$.byteAnyRequiredHugoContentType")
            .value(is(DEFAULT_BYTE_ANY_REQUIRED_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteAnyRequiredHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_REQUIRED_HUGO)))
            .jsonPath("$.byteAnyMinbytesHugoContentType")
            .value(is(DEFAULT_BYTE_ANY_MINBYTES_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteAnyMinbytesHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MINBYTES_HUGO)))
            .jsonPath("$.byteAnyMaxbytesHugoContentType")
            .value(is(DEFAULT_BYTE_ANY_MAXBYTES_HUGO_CONTENT_TYPE))
            .jsonPath("$.byteAnyMaxbytesHugo")
            .value(is(Base64.getEncoder().encodeToString(DEFAULT_BYTE_ANY_MAXBYTES_HUGO)))
            .jsonPath("$.byteTextHugo")
            .value(is(DEFAULT_BYTE_TEXT_HUGO))
            .jsonPath("$.byteTextRequiredHugo")
            .value(is(DEFAULT_BYTE_TEXT_REQUIRED_HUGO));
    }
    ...
    @Test
    void putExistingFieldTestInfiniteScrollEntity() throws Exception {
        // Initialize the database
        insertedFieldTestInfiniteScrollEntity = fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity).block();
        ...
        webTestClient
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(updatedFieldTestInfiniteScrollEntity))
            .exchange()
            .expectStatus()
            .isOk();
        ...
        assertPersistedFieldTestInfiniteScrollEntityToMatchAllProperties(updatedFieldTestInfiniteScrollEntity);
    }

    @Test
    void putNonExistingFieldTestInfiniteScrollEntity() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        fieldTestInfiniteScrollEntity.setId(longCount.incrementAndGet());
    ...
    void partialUpdateFieldTestInfiniteScrollEntityWithPatch() throws Exception {
        ...
        webTestClient
            ...
            .bodyValue(om.writeValueAsBytes(partialUpdatedFieldTestInfiniteScrollEntity))
            .exchange()
            .expectStatus()
            .isOk();
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertFieldTestInfiniteScrollEntityUpdatableFieldsEquals(
            createUpdateProxyForBean(partialUpdatedFieldTestInfiniteScrollEntity, fieldTestInfiniteScrollEntity),
            getPersistedFieldTestInfiniteScrollEntity(fieldTestInfiniteScrollEntity)
        );
    }
    ...
    void fullUpdateFieldTestInfiniteScrollEntityWithPatch() throws Exception {
        ...
        assertFieldTestInfiniteScrollEntityUpdatableFieldsEquals(
            partialUpdatedFieldTestInfiniteScrollEntity,
            getPersistedFieldTestInfiniteScrollEntity(partialUpdatedFieldTestInfiniteScrollEntity)
        );
    }
    ...
    protected long getRepositoryCount() {
        return fieldTestInfiniteScrollEntityRepository.count().block();
    }
    ...
    protected FieldTestInfiniteScrollEntity getPersistedFieldTestInfiniteScrollEntity(
        FieldTestInfiniteScrollEntity fieldTestInfiniteScrollEntity
    ) {
        return fieldTestInfiniteScrollEntityRepository.findById(fieldTestInfiniteScrollEntity.getId()).block();
    }

    protected void assertPersistedFieldTestInfiniteScrollEntityToMatchAllProperties(
        FieldTestInfiniteScrollEntity expectedFieldTestInfiniteScrollEntity
    ) {
        // Test fails because reactive api returns an empty object instead of null
        // assertFieldTestInfiniteScrollEntityAllPropertiesEquals(expectedFieldTestInfiniteScrollEntity, getPersistedFieldTestInfiniteScrollEntity(expectedFieldTestInfiniteScrollEntity));
        assertFieldTestInfiniteScrollEntityUpdatableFieldsEquals(
            expectedFieldTestInfiniteScrollEntity,
            getPersistedFieldTestInfiniteScrollEntity(expectedFieldTestInfiniteScrollEntity)
        );
    }

    protected void assertPersistedFieldTestInfiniteScrollEntityToMatchUpdatableProperties(
        FieldTestInfiniteScrollEntity expectedFieldTestInfiniteScrollEntity
    ) {
        // Test fails because reactive api returns an empty object instead of null
        // assertFieldTestInfiniteScrollEntityAllUpdatablePropertiesEquals(expectedFieldTestInfiniteScrollEntity, getPersistedFieldTestInfiniteScrollEntity(expectedFieldTestInfiniteScrollEntity));
        assertFieldTestInfiniteScrollEntityUpdatableFieldsEquals(
            expectedFieldTestInfiniteScrollEntity,
            getPersistedFieldTestInfiniteScrollEntity(expectedFieldTestInfiniteScrollEntity)
        );
