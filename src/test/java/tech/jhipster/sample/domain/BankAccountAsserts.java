...
public class BankAccountAsserts {
    ...
    public static void assertBankAccountUpdatableFieldsEquals(BankAccount expected, BankAccount actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getGuid()).as("check guid").isEqualTo(expected.getGuid()))
            ...
            .satisfies(a -> assertThat(a.getMeanQueueDuration()).as("check meanQueueDuration").isEqualTo(expected.getMeanQueueDuration()))
            .satisfies(a ->
