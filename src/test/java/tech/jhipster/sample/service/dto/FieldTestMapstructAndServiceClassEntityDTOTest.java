...
class FieldTestMapstructAndServiceClassEntityDTOTest {
    ...
    void dtoEqualsVerifier() throws Exception {
        ...
        FieldTestMapstructAndServiceClassEntityDTO fieldTestMapstructAndServiceClassEntityDTO1 =
            new FieldTestMapstructAndServiceClassEntityDTO();
        fieldTestMapstructAndServiceClassEntityDTO1.setId(1L);
        FieldTestMapstructAndServiceClassEntityDTO fieldTestMapstructAndServiceClassEntityDTO2 =
            new FieldTestMapstructAndServiceClassEntityDTO();
