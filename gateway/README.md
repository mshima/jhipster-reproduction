...
We use npm scripts and Rsbuild as our build system.
...
Then you would import the JS and CSS files specified in library's installation instructions so that [Rsbuild][] knows about them:
