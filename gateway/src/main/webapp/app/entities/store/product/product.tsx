      ...
      <h2 id="product-heading" data-cy="ProductHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.storeProduct.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.storeProduct.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
