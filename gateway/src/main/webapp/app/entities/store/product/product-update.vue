    ...
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="gatewayApp.storeProduct.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
          {{ t$('gatewayApp.storeProduct.home.createOrEditLabel') }}
        </h2>
        <div>
          ...
          <div class="mb-3">
            <label class="form-control-label" for="product">{{ t$('gatewayApp.storeProduct.title') }}</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="product">{{ t$('gatewayApp.storeProduct.price') }}</label>
            <input
              type="number"
              class="form-control"
              name="price"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="product">{{ t$('gatewayApp.storeProduct.image') }}</label>
            <div>
              <img
