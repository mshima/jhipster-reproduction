...
describe('UserData e2e test', () => {
  ...
  it('UserDatas menu should load UserDatas page', () => {
    cy.visit('/');
    ...
    cy.location('pathname').should('eq', userDataPageUrl);
  });

  describe('UserData page', () => {
    it('should have translated page title', () => {
      cy.visit(userDataPageUrl);
      cy.getEntityHeading('UserData').should('not.contain', 'gatewayApp.userData.home.title');
    });
    ...
    describe('create button click', () => {
      ...
      it('should load create UserData page', () => {
        ...
        cy.location('pathname').should('eq', `${userDataPageUrl}/new`);
