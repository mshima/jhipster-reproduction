  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button as={Link as any} to="/blog/tag" replace variant="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button as={Link as any} to={`/blog/tag/${tagEntity.id}/edit`} replace variant="primary">
