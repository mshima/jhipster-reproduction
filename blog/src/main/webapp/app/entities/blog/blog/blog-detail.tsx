  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button as={Link as any} to="/blog/blog" replace variant="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button as={Link as any} to={`/blog/blog/${blogEntity.id}/edit`} replace variant="primary">
