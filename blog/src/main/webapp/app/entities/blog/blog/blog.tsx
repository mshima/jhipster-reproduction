      ...
      <div className="table-responsive">
        {blogList?.length > 0 ? (
          <Table responsive>
            ...
            <tbody>
              {blogList.map(blog => (
                <tr key={`entity-${blog.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/blog/blog/${blog.id}`} variant="link" size="sm">
                      {blog.id}
                    </Button>
                  </td>
                  <td>{blog.name}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button as={Link as any} to={`/blog/blog/${blog.id}`} variant="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button as={Link as any} to={`/blog/blog/${blog.id}/edit`} variant="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (globalThis.location.href = `/blog/blog/${blog.id}/delete`)}
                        variant="danger"
                        size="sm"
