    ...
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="blogApp.blogBlog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading">
          {{ t$('blogApp.blogBlog.home.createOrEditLabel') }}
        </h2>
        <div>
          <div class="mb-3" v-if="blog.id">
            <label for="id">{{ t$('global.field.id') }}</label>
            <input type="text" class="form-control" id="id" name="id" v-model="blog.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="blog">{{ t$('blogApp.blogBlog.name') }}</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="blog">{{ t$('blogApp.blogBlog.handle') }}</label>
            <input
              type="text"
              class="form-control"
              name="handle"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="blog">{{ t$('blogApp.blogBlog.user') }}</label>
