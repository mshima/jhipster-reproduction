...
public class ProductService {
    ...
    public Optional<ProductEntity> partialUpdate(ProductEntity productEntity) {
        ...
        return productRepository
            ...
            .map(existingProduct -> {
                updateIfPresent(existingProduct::setTitle, productEntity.getTitle());
                updateIfPresent(existingProduct::setPrice, productEntity.getPrice());
                updateIfPresent(existingProduct::setImage, productEntity.getImage());
                updateIfPresent(existingProduct::setImageContentType, productEntity.getImageContentType());
