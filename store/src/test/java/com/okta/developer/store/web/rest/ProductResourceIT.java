...
class ProductResourceIT {
    ...
    void createProduct() throws Exception {
        ...
        var returnedProductEntity = om.readValue(
            restProductMockMvc
                .perform(
                    post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productEntity))
                )
    ...
    void createProductWithExistingId() throws Exception {
        ...
        restProductMockMvc
            .perform(post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productEntity)))
    ...
    void putWithMissingIdPathParamProduct() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restProductMockMvc
            .perform(put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productEntity)))
    ...
    void patchWithMissingIdPathParamProduct() throws Exception {
        ...
        restProductMockMvc
            .perform(
                patch(ENTITY_API_URL).with(csrf()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(productEntity))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteProduct() throws Exception {
        ...
        // Delete the product
        restProductMockMvc
            .perform(delete(ENTITY_API_URL_ID, productEntity.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
