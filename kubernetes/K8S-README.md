...
```
$ docker image tag gateway hipsterslabs/gateway
$ docker push hipsterslabs/gateway
$ docker image tag store hipsterslabs/store
$ docker push hipsterslabs/store
$ docker image tag blog hipsterslabs/blog
$ docker push hipsterslabs/blog
$ docker image tag notification hipsterslabs/notification
$ docker push hipsterslabs/notification
```
